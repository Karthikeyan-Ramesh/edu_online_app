...
<div class="brd">
<h1 style="color:#d58d15;margin-top:-10px;">Edit Student Details</h1>
...
<input type="password" name="pass" placeholder="New Password" style="margin-top:20px;margin-left:3px;"><font color="red" size="5">*</font>
<input type="password" name="repass" placeholder="Confirm Password" style="margin-top:40px;margin-left:3px;"><font color="red" size="5">*</font>
...
<input type="file" name="image" style="margin-top:20px;margin-left:1px;" required><font color="red" size="5">*</font>
